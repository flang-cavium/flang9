...
private:
  ...
  SDValue SoftenFloatRes_FLGAMMA(SDNode *N);
  SDValue SoftenFloatRes_FTGAMMA(SDNode *N);
  ...
  void ExpandFloatRes_FLGAMMA    (SDNode *N, SDValue &Lo, SDValue &Hi);
  void ExpandFloatRes_FTGAMMA    (SDNode *N, SDValue &Lo, SDValue &Hi);
