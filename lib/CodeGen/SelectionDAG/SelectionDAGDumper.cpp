...
std::string SDNode::getOperationName(const SelectionDAG *G) const {
  ...
  case ISD::FLGAMMA:                    return "flgamma";
  case ISD::STRICT_FLGAMMA:             return "strict_flgamma";
  case ISD::FTGAMMA:                    return "ftgamma";
  case ISD::STRICT_FTGAMMA:             return "strict_ftgamma";
  case ISD::FEXP10:                     return "fexp10";
  case ISD::STRICT_FEXP10:              return "strict_fexp10";
