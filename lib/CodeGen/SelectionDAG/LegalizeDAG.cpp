...
void SelectionDAGLegalize::ConvertNodeToLibcall(SDNode *Node) {
  ...
  case ISD::STRICT_FACOS:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_acos_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ACOS_FINITE_F32,
                                        RTLIB::ACOS_FINITE_F64,
                                        RTLIB::ACOS_FINITE_F80,
                                        RTLIB::ACOS_FINITE_F128,
                                        RTLIB::ACOS_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ACOS_F32,
                                        RTLIB::ACOS_F64,
                                        RTLIB::ACOS_F80,
                                        RTLIB::ACOS_F128,
                                        RTLIB::ACOS_PPCF128));
  ...
  case ISD::STRICT_FASIN:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_asin_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ASIN_FINITE_F32,
                                        RTLIB::ASIN_FINITE_F64,
                                        RTLIB::ASIN_FINITE_F80,
                                        RTLIB::ASIN_FINITE_F128,
                                        RTLIB::ASIN_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ASIN_F32,
                                        RTLIB::ASIN_F64,
                                        RTLIB::ASIN_F80,
                                        RTLIB::ASIN_F128,
                                        RTLIB::ASIN_PPCF128));
  ...
  case ISD::STRICT_FATAN2:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_atan2_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ATAN2_FINITE_F32,
                                        RTLIB::ATAN2_FINITE_F64,
                                        RTLIB::ATAN2_FINITE_F80,
                                        RTLIB::ATAN2_FINITE_F128,
                                        RTLIB::ATAN2_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ATAN2_F32,
                                        RTLIB::ATAN2_F64,
                                        RTLIB::ATAN2_F80,
                                        RTLIB::ATAN2_F128,
                                        RTLIB::ATAN2_PPCF128));
  ...
  case ISD::STRICT_FCOSH:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_cosh_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::COSH_FINITE_F32,
                                        RTLIB::COSH_FINITE_F64,
                                        RTLIB::COSH_FINITE_F80,
                                        RTLIB::COSH_FINITE_F128,
                                        RTLIB::COSH_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::COSH_F32,
                                        RTLIB::COSH_F64,
                                        RTLIB::COSH_F80,
                                        RTLIB::COSH_F128,
                                        RTLIB::COSH_PPCF128));
  ...
  case ISD::STRICT_FSINH:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_sinh_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::SINH_FINITE_F32,
                                        RTLIB::SINH_FINITE_F64,
                                        RTLIB::SINH_FINITE_F80,
                                        RTLIB::SINH_FINITE_F128,
                                        RTLIB::SINH_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::SINH_F32,
                                        RTLIB::SINH_F64,
                                        RTLIB::SINH_F80,
                                        RTLIB::SINH_F128,
                                        RTLIB::SINH_PPCF128));
  ...
  case ISD::STRICT_FACOSH:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_acosh_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ACOSH_FINITE_F32,
                                        RTLIB::ACOSH_FINITE_F64,
                                        RTLIB::ACOSH_FINITE_F80,
                                        RTLIB::ACOSH_FINITE_F128,
                                        RTLIB::ACOSH_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ACOSH_F32,
                                        RTLIB::ACOSH_F64,
                                        RTLIB::ACOSH_F80,
                                        RTLIB::ACOSH_F128,
                                        RTLIB::ACOSH_PPCF128));
  ...
  case ISD::STRICT_FATANH:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_atanh_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ATANH_FINITE_F32,
                                        RTLIB::ATANH_FINITE_F64,
                                        RTLIB::ATANH_FINITE_F80,
                                        RTLIB::ATANH_FINITE_F128,
                                        RTLIB::ATANH_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::ATANH_F32,
                                        RTLIB::ATANH_F64,
                                        RTLIB::ATANH_F80,
                                        RTLIB::ATANH_F128,
                                        RTLIB::ATANH_PPCF128));
    break;
  case ISD::FEXP10:
  case ISD::STRICT_FEXP10:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_exp10_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::EXP10_FINITE_F32,
                                        RTLIB::EXP10_FINITE_F64,
                                        RTLIB::EXP10_FINITE_F80,
                                        RTLIB::EXP10_FINITE_F128,
                                        RTLIB::EXP10_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::EXP10_F32,
                                        RTLIB::EXP10_F64,
                                        RTLIB::EXP10_F80,
                                        RTLIB::EXP10_F128,
                                        RTLIB::EXP10_PPCF128));
  ...
  case ISD::STRICT_FLGAMMA:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_lgamma_r_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::LGAMMA_FINITE_F32,
                                        ...
                                        RTLIB::LGAMMA_FINITE_F128,
                                        RTLIB::LGAMMA_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::LGAMMA_F32,
                                        RTLIB::LGAMMA_F64,
                                        RTLIB::LGAMMA_F80,
                                        RTLIB::LGAMMA_F128,
                                        RTLIB::LGAMMA_PPCF128));
    break;
  case ISD::FTGAMMA:
  case ISD::STRICT_FTGAMMA:
    if (CanUseFiniteLibCall && DAG.getLibInfo().has(LibFunc_tgamma_finite))
      Results.push_back(ExpandFPLibCall(Node, RTLIB::TGAMMA_FINITE_F32,
                                        RTLIB::TGAMMA_FINITE_F64,
                                        RTLIB::TGAMMA_FINITE_F80,
                                        RTLIB::TGAMMA_FINITE_F128,
                                        RTLIB::TGAMMA_FINITE_PPCF128));
    else
      Results.push_back(ExpandFPLibCall(Node, RTLIB::TGAMMA_F32,
                                        RTLIB::TGAMMA_F64,
                                        RTLIB::TGAMMA_F80,
                                        RTLIB::TGAMMA_F128,
                                        RTLIB::TGAMMA_PPCF128));
    break;
  case ISD::FTRUNC:
  case ISD::STRICT_FTRUNC:
