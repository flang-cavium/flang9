...
bool DAGTypeLegalizer::SoftenFloatResult(SDNode *N, unsigned ResNo) {
  ...
  default:
    ...
    case ISD::FLGAMMA:     R = SoftenFloatRes_FLGAMMA(N); break;
    case ISD::FTGAMMA:     R = SoftenFloatRes_FTGAMMA(N); break;
...
SDValue DAGTypeLegalizer::SoftenFloatRes_FLGAMMA(SDNode *N) {
  EVT NVT = TLI.getTypeToTransformTo(*DAG.getContext(), N->getValueType(0));
  SDValue Op = GetSoftenedFloat(N->getOperand(0));
  return TLI.makeLibCall(DAG, GetFPLibCall(N->getValueType(0),
                                           RTLIB::LGAMMA_F32,
...
SDValue DAGTypeLegalizer::SoftenFloatRes_FTGAMMA(SDNode *N) {
  EVT NVT = TLI.getTypeToTransformTo(*DAG.getContext(), N->getValueType(0));
  SDValue Op = GetSoftenedFloat(N->getOperand(0));
  return TLI.makeLibCall(DAG, GetFPLibCall(N->getValueType(0),
                                           RTLIB::TGAMMA_F32,
...
void DAGTypeLegalizer::ExpandFloatResult(SDNode *N, unsigned ResNo) {
  ...
  case ISD::FLGAMMA:    ExpandFloatRes_FLGAMMA(N, Lo, Hi); break;
  case ISD::FTGAMMA:    ExpandFloatRes_FTGAMMA(N, Lo, Hi); break;
  }
...
void DAGTypeLegalizer::ExpandFloatRes_FTANH(SDNode *N,
                                            SDValue &Lo, SDValue &Hi) {
  SDValue Call = LibCallify(GetFPLibCall(N->getValueType(0),
                                         RTLIB::TANH_F32, RTLIB::TANH_F64,
...
void DAGTypeLegalizer::ExpandFloatRes_FASINH(SDNode *N,
                                             SDValue &Lo, SDValue &Hi) {
  SDValue Call = LibCallify(GetFPLibCall(N->getValueType(0),
                                         RTLIB::ASINH_F32, RTLIB::ASINH_F64,
...
void DAGTypeLegalizer::ExpandFloatRes_FACOSH(SDNode *N,
                                             SDValue &Lo, SDValue &Hi) {
  SDValue Call = LibCallify(GetFPLibCall(N->getValueType(0),
                                         RTLIB::ACOSH_F32, RTLIB::ACOSH_F64,
...
void DAGTypeLegalizer::ExpandFloatRes_FATANH(SDNode *N,
                                             SDValue &Lo, SDValue &Hi) {
  SDValue Call = LibCallify(GetFPLibCall(N->getValueType(0),
                                         RTLIB::ATANH_F32, RTLIB::ATANH_F64,
...
void DAGTypeLegalizer::ExpandFloatRes_FLGAMMA(SDNode *N,
                                              SDValue &Lo, SDValue &Hi) {
  SDValue Call = LibCallify(GetFPLibCall(N->getValueType(0),
                                         RTLIB::LGAMMA_F32, RTLIB::LGAMMA_F64,
                                         RTLIB::LGAMMA_F80, RTLIB::LGAMMA_F128,
                                         RTLIB::LGAMMA_PPCF128),
                            N, false);
  GetPairElements(Call, Lo, Hi);
}

void DAGTypeLegalizer::ExpandFloatRes_FTGAMMA(SDNode *N,
                                              SDValue &Lo, SDValue &Hi) {
  SDValue Call = LibCallify(GetFPLibCall(N->getValueType(0),
                                         RTLIB::TGAMMA_F32, RTLIB::TGAMMA_F64,
                                         RTLIB::TGAMMA_F80, RTLIB::TGAMMA_F128,
                                         RTLIB::TGAMMA_PPCF128),
                            N, false);
  GetPairElements(Call, Lo, Hi);
}

void DAGTypeLegalizer::ExpandFloatRes_FEXP10(SDNode *N,
                                             SDValue &Lo, SDValue &Hi) {
  SDValue Call = LibCallify(GetFPLibCall(N->getValueType(0),
                                         RTLIB::EXP10_F32, RTLIB::EXP10_F64,
...
void DAGTypeLegalizer::PromoteFloatResult(SDNode *N, unsigned ResNo) {
  ...
  switch (N->getOpcode()) {
    ...
    case ISD::FLGAMMA:
    case ISD::FTGAMMA:
    case ISD::FEXP10:       R = PromoteFloatRes_UnaryOp(N); break;
    ...
    case ISD::FREM:
    case ISD::FSUB:
    case ISD::FATAN2:     R = PromoteFloatRes_BinOp(N); break;
