...
SDNode* SelectionDAG::mutateStrictFPToFP(SDNode *Node) {
  ...
  case ISD::STRICT_FASINH:     NewOpc = ISD::FASINH;     break;
  case ISD::STRICT_FACOSH:     NewOpc = ISD::FACOSH;     break;
  case ISD::STRICT_FATANH:     NewOpc = ISD::FATANH;     break;
  case ISD::STRICT_FLGAMMA:    NewOpc = ISD::FLGAMMA;    break;
  case ISD::STRICT_FTGAMMA:    NewOpc = ISD::FTGAMMA;    break;
  case ISD::STRICT_FEXP10:     NewOpc = ISD::FEXP10;     break;
