...
void SelectionDAGBuilder::visitIntrinsicCall(const CallInst &I,
  ...
  case Intrinsic::lgamma:
  case Intrinsic::tgamma:
  case Intrinsic::exp10: {
    const char *EFN;
    llvm::EVT OpEVT = getValue(I.getArgOperand(0)).getValueType();
    llvm::MVT OpMVT = OpEVT.isVector() ?
      OpEVT.getVectorElementType().getSimpleVT() :
      OpEVT.getSimpleVT();
    ...
    case Intrinsic::acos:
      EFN =
        OpMVT == MVT::f32 ? "acosf" : OpMVT == MVT::f64 ? "acos" : "acosl";
      break;
    case Intrinsic::asin:
      EFN =
        OpMVT == MVT::f32 ? "asinf" : OpMVT == MVT::f64 ? "asin" : "asinl";
      break;
    case Intrinsic::atan:
      EFN =
        OpMVT == MVT::f32 ? "atanf" : OpMVT == MVT::f64 ? "atan" : "atanl";
      break;
    case Intrinsic::atan2:
      EFN =
        OpMVT == MVT::f32 ? "atan2f" : OpMVT == MVT::f64 ? "atan2" : "atan2l";
      break;
    case Intrinsic::tan:
      EFN =
        OpMVT == MVT::f32 ? "tanf" : OpMVT == MVT::f64 ? "tan" : "tanl";
      break;
    case Intrinsic::cosh:
      EFN =
        OpMVT == MVT::f32 ? "coshf" : OpMVT == MVT::f64 ? "cosh" : "coshl";
      break;
    case Intrinsic::sinh:
      EFN =
        OpMVT == MVT::f32 ? "sinhf" : OpMVT == MVT::f64 ? "sinh" : "sinhl";
      break;
    case Intrinsic::tanh:
      EFN =
        OpMVT == MVT::f32 ? "tanhf" : OpMVT == MVT::f64 ? "tanh" : "tanhl";
      break;
    case Intrinsic::acosh:
      EFN =
        OpMVT == MVT::f32 ? "acoshf" : OpMVT == MVT::f64 ? "acosh" : "acoshl";
      break;
    case Intrinsic::asinh:
      EFN =
        OpMVT == MVT::f32 ? "asinhf" : OpMVT == MVT::f64 ? "asinh" : "asinhl";
      break;
    case Intrinsic::atanh:
      EFN =
        OpMVT == MVT::f32 ? "atanhf" : OpMVT == MVT::f64 ? "atanh" : "atanhl";
      break;
    case Intrinsic::lgamma:
      if (IsFastMath || IsFiniteMathOnly)
        EFN = OpMVT == MVT::f32 ? "__lgammaf_r_finite" :
          OpMVT == MVT::f64 ? "__lgamma_r_finite" :
          "__lgammal_r_finite";
      else
        EFN = OpMVT == MVT::f32 ? "lgammaf" :
          OpMVT == MVT::f64 ? "lgamma" : "lgammal";
      break;
    case Intrinsic::tgamma:
      EFN = OpMVT == MVT::f32 ? "tgammaf" :
        OpMVT == MVT::f64 ? "tgamma" : "tgammal";
      break;
    case Intrinsic::exp10:
      EFN =
        OpMVT == MVT::f32 ? "exp10f" : OpMVT == MVT::f64 ? "exp10" : "exp10l";
      break;
    }

    lowerCallToExternalSymbol(I, EFN);
    return;
    break;
  }
