...
namespace ISD {
  ...
  enum NodeType {
    ...
    /// Vectorized libm functions from an external library (i.e. SLEEF).
    STRICT_FACOS, STRICT_FASIN, STRICT_FATAN, STRICT_FATAN2,
    STRICT_FTAN, STRICT_FCOSH, STRICT_FSINH, STRICT_FTANH,
    STRICT_FASINH, STRICT_FACOSH, STRICT_FATANH, STRICT_FLGAMMA,
    STRICT_FTGAMMA, STRICT_FEXP10,
    FACOS, FASIN, FATAN, FATAN2, FTAN, FCOSH, FSINH, FTANH,
    FASINH, FACOSH, FATANH, FLGAMMA, FTGAMMA, FEXP10,
