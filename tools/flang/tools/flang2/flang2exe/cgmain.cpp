...
cons_novectorize_metadata(void)
{
  ...
  LL_MDRef rv = ll_create_flexible_md_node(cpu_llvm_module);
  if (get_llvm_version() < LL_Version_8_0) {
    LL_MDRef lvcomp[2];
    ...
    LL_MDRef lvcomp[8];
    lvcomp[0] = ll_get_md_string(cpu_llvm_module,
                                 "llvm.loop.vectorize.enable");
    lvcomp[1] = ll_get_md_i1(0);
    lvcomp[2] = ll_get_md_string(cpu_llvm_module,
                                 "llvm.loop.vectorize.followup_all");
    lvcomp[3] = ll_get_md_i1(0);
    lvcomp[4] = ll_get_md_string(cpu_llvm_module,
                                 "llvm.loop.vectorize.followup_vectorized");
    lvcomp[5] = ll_get_md_i1(0);
    lvcomp[6] = ll_get_md_string(cpu_llvm_module,
                                 "llvm.loop.vectorize.followup_epilogue");
    lvcomp[7] = ll_get_md_i1(0);
...
cons_vectorize_metadata(void)
{
  if (get_llvm_version() < LL_Version_8_0) {
    ...
    lvcomp[2] = ll_get_md_string(cpu_llvm_module,
                                 "llvm.loop.vectorize.followup_all");
    lvcomp[3] = ll_get_md_i1(1);
    lvcomp[4] = ll_get_md_string(cpu_llvm_module,
                                 "llvm.loop.vectorize.followup_vectorized");
    lvcomp[5] = ll_get_md_i1(1);
    lvcomp[6] = ll_get_md_string(cpu_llvm_module,
                                 "llvm.loop.vectorize.followup_epilogue");
    lvcomp[7] = ll_get_md_i1(1);
    return ll_get_md_node(cpu_llvm_module, LL_PlainMDNode, lvcomp, 8);
  }
}
    ...
    if (instrs->flags & CANCEL_CALL_DBG_VALUE) {
      ...
      case I_FILTER: {
        ...
        if (instrs->operands == NULL) {
          ...
          char buffer[256];    /* Format string + small integer */
