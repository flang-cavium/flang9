...
#if !defined(_NDEBUG) || defined(_XDEBUG) || defined(XDEBUG)
#define DEBUG 1
#endif
...
static pthread_mutex_t mutex_allo = PTHREAD_MUTEX_INITIALIZER;
...
__f90_allo_term(void)
{
  if (savedalloc.valid != -99) {
    ...
    pthread_mutex_unlock(&mutex_allo);
  }
}
#endif
