; RUN: opt -mcpu=thunderx2t99 vector-library=SLEEF -tli-max-vector-width-for-target=128 -tli-use-fast-math=true --fp-contract=fast --enable-no-trapping-fp-math=true -loop-vectorize -S < %s | FileCheck %s
...
define void @acos_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_acos_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @acos_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_acosf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @asin_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_asin_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @asin_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_asinf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_atan_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_atanf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan2_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2vv_atan2_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atan2_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4vv_atan2f_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atanh_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_atanh(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @atanh_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_atanhf(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cos_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @cos_f64(
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_cos_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cos_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @cos_f32(
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_cosf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cosh_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_cosh_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @cosh_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_coshf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @exp_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @exp_f64(
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_exp(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @exp_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @exp_f32(
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_expf(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @exp2_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_exp2_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @exp2_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_exp2f_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @exp10_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_exp10_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @exp10_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_exp10f_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log10_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_log10(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log10_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_log10f(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log2_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_log2_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log2_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_log2f_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @log_f64(
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_log_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @log_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @log_f32(
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_logf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @pow_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @pow_f64(
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2vv_pow(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @pow_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @pow_f32(
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4vv_powf(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sin_f64(double* nocapture %varray) {
  ; CHECK-LABEL: @sin_f64(
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_sin_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sin_f32(float* nocapture %varray) {
  ; CHECK-LABEL: @sin_f32(
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_sinf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sinh_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_sinh_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sinh_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_sinhf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sqrt_f64(double* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <2 x double> @_ZGVnN2v_sqrt_u35(<2 x double> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @sqrt_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_sqrtf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
...
define void @tanh_f32(float* nocapture %varray) {
  ...
  ; CHECK:    [[TMP5:%.*]] = call fast <4 x float> @_ZGVnN4v_tanhf_u35(<4 x float> [[TMP4:%.*]])
  ; CHECK:    ret void
  ;
  entry:
  br label %for.body
